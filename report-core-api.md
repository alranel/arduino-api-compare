...
| `void` | `attachInterrupt(PinName interruptNumber, voidFuncPtr callback, PinStatus mode)` | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
|        | `bit( b)`                                                                        | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
...
|        | `cos(x )`                                                                        | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `delay(uint32_t ms)`                                                             | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `delayMicroseconds(unsigned int us)`                                             | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `detachInterrupt(pin_size_t pin)`                                                | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `digitalWrite(pin_size_t pinNumber, int status)`                                 | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
...
| `void` | `pinMode(PinName pin, PinMode mode)`                                             | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
|        | `pow(x )`                                                                        | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `long` | `random(long howbig)`                                                            | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `randomSeed(unsigned long )`                                                     | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `shiftOut(PinName dataPin, PinName clockPin, BitOrder bitOrder, uint8_t val)`    | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
|        | `sin(x )`                                                                        | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
|        | `sqrt(x )`                                                                       | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
|        | `tan(x )`                                                                        | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `tone(uint8_t _pin, unsigned int frequency, unsigned long duration = 0)`         | ✔️              | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
|        | **Differing return values**                                                      |                 |                 |                 |                 |                 |            |
|        | `analogRead(pin_size_t pin)`                                                     | `int`           | `int`           | `int`           | `int`           | `uint16_t`      | `uint32_t` |
...
|        | `pulseInLong(uint32_t pin, uint32_t state, uint32_t timeout)`                    | `unsigned long` | `unsigned long` | `unsigned long` | `unsigned long` | `unsigned long` | `uint32_t` |
|        | `shiftIn(uint32_t ulDataPin, uint32_t ulClockPin, uint32_t ulBitOrder)`          | `uint8_t`       | `uint8_t`       | `uint8_t`       | `pin_size_t`    | `uint8_t`       | `uint32_t` |
|        | `sq( x)`                                                                         | ``              | ``              | ``              | `auto`          | ``              | ``         |
|        | **Limited compatibility**                                                        |                 |                 |                 |                 |                 |            |
| `void` | `analogReadResolution(int res)`                                                  |                 | ✔️              | ✔️              | ✔️              | ✔️              | ✔️         |
| `void` | `analogReference(uint8_t mode)`                                                  | ✔️              | ✔️              | ✔️              | ✔️              |                 | ✔️         |
| `void` | `analogWriteResolution(int res)`                                                 |                 | ✔️              | ✔️              |                 |                 | ✔️         |
| `int`  | `interrupts()`                                                                   | ✔️              | ✔️              |                 |                 |                 |            |
| `auto` | `max(const  &T a, const L & b)`                                                  | ✔️              | ✔️              | ✔️              | ✔️              |                 |            |
|        | `min( a,  b)`                                                                    | ✔️              | ✔️              | ✔️              | ✔️              |                 |            |
| `int`  | `noInterrupts()`                                                                 | ✔️              | ✔️              |                 |                 |                 |            |
...
_Generated on Mon, 13 Feb 2023 10:13:58 UTC with [cpp-api-compare](https://github.com/alranel/cpp-api-compare)._
